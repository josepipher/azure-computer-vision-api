...
def recognizeDomainSpecificContent(visionheaders,body):
  # There are only 2 models : "Celebrities" and "Landmarks"
  # get_models = requests.get("https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/models/", headers=visionheaders)
